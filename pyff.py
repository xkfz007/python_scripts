...
def get_cmd_line(input_file, ext, output_tmp, prepared_cmd, extra_cmd):
    ...
    if len(ext) == 0 :
        ...
        if ext in bitstream_name_list and fext =='mp4':
            extra_cmd += " -bsf %s" % bsf_for_mp4[ext]
...
if __name__ == '__main__':
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:], 'i:e:aC:t:w:h:YH')
    ...
    for input_file in input_list:
        ...
        if os.path.isfile(input_file):
            ...
            cmd_line = get_cmd_line(input_file, extension, output_tmp, prepared_cmd, extra_cmd)
            print cmd_line
